...
const Uncontrolled: React.FC<Props> = (props) => {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    props.onAddHabit(habitNameRef.current?.value,
      habitDescriptionRef.current?.value,
      habitIconRef.current?.value,
      selectedColour,
      habitGoalRef.current?.value,
      habitGoalPeriodRef.current?.value,
      habitStartDateRef.current?.value,
